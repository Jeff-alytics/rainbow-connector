...
function event({ bearing = 5, distance = 10, source = "FAA WeatherCam", quality = null, offsets = [0, 3, 6, 9, 12] } = {}) {
  const target = Date.parse("2026-07-29T20:00:00Z");
  return {
    representative: { detectedAt: new Date(target).toISOString() },
    evidence: {
      source,
      camera: { bearingDifference: bearing, distanceKm: distance, viewQuality: quality },
